...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_NAV] = LAYOUT_split_3x6_3(
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                           KC_PGUP, LCTL(KC_LEFT), KC_UP, LCTL(KC_RIGHT), LCTL(LALT(KC_DEL)), KC_TRNS,
        KC_TRNS, LCTL(KC_A), KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI,                        KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END, KC_TRNS,
        KC_TRNS, LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_TRNS,               KC_PGDN, KC_APP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
