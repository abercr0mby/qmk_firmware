...
tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_CUT] = ACTION_TAP_DANCE_DOUBLE(KC_1, LCTL(KC_X)),
  [TD_COPY] = ACTION_TAP_DANCE_DOUBLE(KC_2, LCTL(KC_C)),
  [TD_PASTE] = ACTION_TAP_DANCE_DOUBLE(KC_3, LCTL(KC_V)),
  [TD_EQUAL] = ACTION_TAP_DANCE_DOUBLE(KC_EQUAL, KC_PERC),
  [TD_PLUS] = ACTION_TAP_DANCE_DOUBLE(KC_PLUS, KC_DOT),
  [TD_MINUS] = ACTION_TAP_DANCE_DOUBLE(KC_MINUS, KC_DLR),
  [TD_VTOC] = ACTION_TAP_DANCE_DOUBLE(KC_V, KC_C)
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_DEFAULT] = LAYOUT_split_3x6_3(
        ...
        KC_NO, LGUI_T(KC_A), LSFT_T(KC_S), LCTL_T(KC_D), LALT_T(KC_F), KC_G,            KC_H, LALT_T(KC_J), LCTL_T(KC_K), LSFT_T(KC_L), LGUI_T(KC_QUOT), KC_NO,
        KC_NO, KC_Z, KC_X, KC_C, TD(TD_VTOC), KC_B,                                     KC_N, KC_M, KC_COMM, KC_DOT, TD(TD_SLASH), KC_NO,
	...
	[_ADJUST] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                           KC_GRV, KC_PIPE, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS,                                                      KC_TRNS, KC_TRNS, KC_TRNS),

    [_NUM] = LAYOUT_split_3x6_3(
        KC_TRNS, TD(TD_PLUS), KC_7, KC_8, KC_9, TD(TD_MINUS),                           TD(TD_PAR), TD(TD_AB), TD(TD_EXLM), TD(TD_AT), TD(TD_UNDS), KC_TRNS,
        KC_TRNS, KC_PAST, KC_4, KC_5, KC_6, TD(TD_DATE),                                TD(TD_BRC), KC_LALT, KC_LCTL, KC_LSFT, KC_LGUI, KC_TRNS,
        KC_TRNS, KC_0, KC_1, KC_2, KC_3, TD(TD_EQUAL),                           TD(TD_BKT), TD(TD_AMP), KC_COMM, KC_DOT, TD(TD_SLASH), KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS,                                                      KC_TRNS, KC_TRNS, KC_TRNS),

    [_SYMBOL] = LAYOUT_split_3x6_3(
        KC_TRNS, TD(TD_UNDS), TD(TD_AT), TD(TD_EXLM), TD(TD_AB), TD(TD_PAR),                     TD(TD_PAR), TD(TD_AB), TD(TD_EXLM), TD(TD_AT), TD(TD_UNDS), KC_TRNS,
        KC_TRNS, LGUI_T(KC_QUOT), LSFT_T(KC_COLN), KC_LCTL, KC_LALT, TD(TD_BRC),                 TD(TD_BRC), TD(TD_AMP), KC_PERC, TD(TD_COLN), TD(TD_QUOT), KC_TRNS,
        KC_TRNS, TD(TD_SLASH), KC_DOT, KC_COMM, TD(TD_CURR), TD(TD_BKT),                         TD(TD_BKT), TD(TD_CURR), KC_COMM, KC_DOT, TD(TD_SLASH), KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS,                                                               KC_TRNS, KC_TRNS, KC_TRNS),

	[_NAV] = LAYOUT_split_3x6_3(
        KC_TRNS, TD(TD_PLUS), KC_7, KC_8, KC_9, TD(TD_MINUS),                                KC_PGUP, LCTL(KC_LEFT), KC_UP, LCTL(KC_RIGHT), LCTL(LALT(KC_DEL)), KC_TRNS,
        KC_TRNS, LGUI_T(KC_PAST), LSFT_T(KC_4), LCTL_T(KC_5), LALT_T(KC_6), TD(TD_DATE),     KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END, KC_TRNS,
        KC_TRNS, KC_0, KC_1, KC_2, KC_3, TD(TD_EQUAL),                                       KC_PGDN, KC_APP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS,  KC_TRNS, KC_TRNS,                                                          KC_TRNS, KC_TRNS, KC_TRNS),
...
const uint16_t PROGMEM cv_ent[] = {KC_C, KC_V, COMBO_END};
